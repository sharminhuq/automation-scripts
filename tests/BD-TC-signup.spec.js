...
test('BD-TC-signup', async ({ page }) => {
    const BDSignUp = process.env.USER_EMAIL || "sharmin.huq+rina@aitrade.ai";
    const TCCopierSignUp = process.env.USER_EMAIL || "sharmin.huq+pakhi@aitrade.ai"; 
    const TCVendorSignUp = process.env.USER_EMAIL || "sharmin.huq+sathi@aitrade.ai"; 
...
//BD SignUp
    ...
    await page.waitForTimeout(10000);
     ...
     await page.locator("//input[@id='folderSearchInput']").fill('rina'); // Fixed issue here
     await page.locator("//a[normalize-space()='rina']").click()
...
await page.waitForSelector("//input[@id='folderSearchInput']");
await page.locator("//input[@id='folderSearchInput']").fill('pakhi'); // Fixed issue here
await page.locator("//a[normalize-space()='pakhi']").click()
await page.locator("//div[contains(@title,'office@backtestdata.com')]").click()
await page.locator("//a[normalize-space()='Verify Email']").click()
await page.waitForSelector("//input[@id='fullName']", { state: 'visible' });
await page.waitForTimeout(10000);
...
await page.waitForSelector("//input[@id='folderSearchInput']");
await page.locator("//input[@id='folderSearchInput']").fill('sathi');
await page.locator("//a[normalize-space()='sathi']").click();
await page.locator("//div[contains(@title,'office@backtestdata.com')]").click();
await page.locator("//a[normalize-space()='Verify Email']").click();
await page.waitForSelector("//input[@id='fullName']", { state: 'visible' });
await page.waitForTimeout(10000);
