...
test('BD-TC-signup', async ({ page }) => {
    const BDSignUp = process.env.USER_EMAIL || "sharmin.huq+tubeCes@aitrade.ai";
    const TCCopierSignUp = process.env.USER_EMAIL || "sharmin.huq+mebus@aitrade.ai"; 
    const TCVendorSignUp = process.env.USER_EMAIL || "sharmin.huq+snigdhas@aitrade.ai"; 
...
//BD SignUp
 ...
 // Email Verification
     ...
     await page.locator("//input[@id='folderSearchInput']").fill('tubeCes'); 
     await page.locator("//a[normalize-space()='tubeces']").click()
...
// THIS  PART IS NOT WORKING, HAS TO FIXED
    ...
    await this.page.locator("//input[@id='fullName']").fill("Sharmin Huq");
    await this.page.locator("//input[@id='password']").fill("Bangladesh1#");
    await this.page.locator("//input[@id='confirmPassword']").fill("Bangladesh1#");
...
await page.goto("https://webmail.migadu.com/");
await page.waitForSelector("//input[@id='folderSearchInput']");
await page.locator("//input[@id='folderSearchInput']").fill('mebus'); // Fixed issue here
await page.locator("//a[normalize-space()='mebus']").click()
